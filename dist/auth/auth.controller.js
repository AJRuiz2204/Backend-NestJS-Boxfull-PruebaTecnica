...
const create_user_dto_1 = require("../packages/dto/create-user.dto");
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Login de un usuario' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Token JWT obtenido correctamente' }),
    (0, swagger_1.ApiBody)({
